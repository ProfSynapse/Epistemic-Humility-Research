...
Analyses:
  ...
  R3 (contamination audit -> papers/paper-1-taxonomy-framework/evidence/rewardcal-contamination-audit.md):
...
Output (deterministic, recomputable; this script is the provenance):
  ...
  papers/paper-1-taxonomy-framework/evidence/rewardcal-contamination-audit.md
  papers/paper-1-taxonomy-framework/analysis/figures/rewardcal_contamination.png
...
HERE = Path(__file__).resolve().parent          # papers/paper-1-taxonomy-framework/analysis
EH = HERE.parents[2]                             # repo root (project root)
...
def main() -> None:
    ...
    r1 = [
        "# Reward-Calibration (CRM) to KTO recipe (auto-generated by papers/paper-1-taxonomy-framework/analysis/rewardcal_audit.py)",
        "",
    ...
    r1 += [
        ...
        "(quantified in papers/paper-1-taxonomy-framework/evidence/rewardcal-contamination-audit.md).",
        "",
