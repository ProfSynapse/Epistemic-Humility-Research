...
each cell is a signed co-located amendment in the appropriate `experiments/`
directory, referencing the locked PROTOCOL surface and never pooled with the
headline matrix.
...
1. **Sign the Amendment** in the appropriate `experiments/` directory
   (prediction + falsifier + locked gates) before any run.
...
- **Definition of done (per cell):** the locked gates have a recorded verdict with
  ...
  assembled in `experiments/cross-model-size-sweep/AMENDMENT.md` §7.
...
- Synthesis: `papers/paper-4-two-signal-readout/notes/framework.md` (Paper 3 seed) and the
...
- 2026-06-30: created (running). S/T/U/Stage-1.5/W complete on Qwen3-4B; framework + KG
  ...
  authorized launch. Tracked in `docs/sessions/20260630T180842Z-two-signal-readout-arc-s-t-u-w-cross-size-generalization-amendment-x.md`.
...
- 2026-06-30 (RESULT: SUCCESS): **Amendment Z COMPLETE, 4/4 scored.** Final veto tally
  **3 PASS (Ministral 0.733, Qwen3.5 0.666 marginal, Gemma-4 0.871) / 1 FAIL (Llama-3.2
  ...
  `experiments/cross-family-confirmatory/AMENDMENT.md` §7.
...
- 2026-07-02 (RESULT: Y COMPLETE — H_B1 SUPPORTED 4/4): **Amendment Y fleet all 10 cells
  ...
  `experiments/pretrain-only-base-readout/AMENDMENT.md` §9; per-cell artifacts
