"""SFT probe-scaled response-confidence seed-1 smoke local config."""
...
def Config():  # noqa: N802 - train_sft.py expects this exact symbol.
    ...
    config.training.output_dir = "scratch/schema_response_confidence/runs/sft_schema_probe_scaled_seed1_smoke"
