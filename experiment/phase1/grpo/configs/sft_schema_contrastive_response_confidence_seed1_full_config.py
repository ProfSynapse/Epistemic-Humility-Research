"""SFT contrastive response-confidence seed-1 full local config."""
...
def Config():  # noqa: N802 - train_sft.py expects this exact symbol.
    ...
    config.dataset.local_file = (
        ...
        "sft_response_confidence_train_contrastive.jsonl"
    )
    ...
    config.training.output_dir = "scratch/schema_response_confidence/runs/sft_schema_contrastive_seed1_full"
