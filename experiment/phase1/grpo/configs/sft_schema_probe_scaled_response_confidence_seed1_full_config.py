"""SFT probe-scaled response-confidence seed-1 full local config."""
...
def Config():  # noqa: N802 - train_sft.py expects this exact symbol.
    ...
    config.training.output_dir = "scratch/schema_response_confidence/runs/sft_schema_probe_scaled_seed1_full"
