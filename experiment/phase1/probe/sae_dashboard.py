...
Usage
-----
    marimo edit experiment/phase1/probe/sae_dashboard.py     # interactive dev
    marimo run  experiment/phase1/probe/sae_dashboard.py     # app server
    marimo export html experiment/phase1/probe/sae_dashboard.py \
...
def _(Path, json, pd, re):
    # --- Roots ---------------------------------------------------------------
    PROBE_ROOT = Path(__file__).resolve().parent          # .../experiment/phase1/probe
    REPO_ROOT = PROBE_ROOT.parents[2]                     # repo root (for repo-relative vector paths)
