...
evidence_base: >
  ...
  experiment/protocol/AMENDMENT-AA-causal-confidence-steering.md,
...
*Draft v0. Companion to [*Knows but Doesn't Say*](paper3-knows-but-doesnt-say-draft-v0.md)
and [*The Confidence Is Already There*](paper4-two-signal-readout-draft-v0.md).*
...
state. The companion diagnosis, [*Knows but Doesn't Say*](paper3-knows-but-doesnt-say-draft-v0.md),
...
follow-up, [*The Confidence Is Already There*](paper4-two-signal-readout-draft-v0.md),
...
|---|---|---|
| Direct activation/text "turn the probe around" cells did not move behavior at registered gates | `experiment/protocol/AMENDMENT-AA-causal-confidence-steering.md` §7 | Falsified / channel shut |
| First-person natural-language confidence framing did not open the text channel at useful magnitude | `experiment/protocol/AMENDMENT-AB-first-person-injection.md` §7-8 | Ambiguous-leaning negative |
| Doubt-coupled activation write carried information in a trained-checkpoint intervention | `experiment/protocol/AMENDMENT-AC-doubt-regulated-caution.md` §8 | Positive |
| High-authority system prompt moved behavior by +18.0pp over permuted | `experiment/protocol/AMENDMENT-AF-second-person-doubt-prime.md` §8 | Pass |
| Inverted system prompt showed asymmetric compliance, not belief revision | `experiment/protocol/AMENDMENT-AG-oracle-dissociation-prime.md` §9 | Pass |
| Divergent-pool test found zero own-readout congruence; Addendum A1 certified the instrument | `experiment/protocol/AMENDMENT-AH-divergent-pool-own-readout.md` §9-10 | H-compliance |
| Probe-as-reward TRUE arm failed to train readout consultation | `experiment/protocol/AMENDMENT-AI-probe-as-reward.md` §5 | Null |
...
- Reconcile this draft against `experiment/paper/results-provenance-inventory.md`.
