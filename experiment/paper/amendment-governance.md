...
Status: working rule for Paper 2 protocol hygiene
...
| Phase 3 mechanism work | Exploratory draft protocol | Keep out of Paper 2 main results; use for a separate paper or future-work sentence only. |
