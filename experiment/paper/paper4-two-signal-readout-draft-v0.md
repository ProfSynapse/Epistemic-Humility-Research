...
Language Model*](paper3-knows-but-doesnt-say-draft-v0.md), for the representation-vs-
...
diagnosis, [*Knows but Doesn't Say*](paper3-knows-but-doesnt-say-draft-v0.md), tests and
