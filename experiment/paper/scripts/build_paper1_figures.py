...
def write_report(
    ...
    lines = [
        ...
        "",
        "Generated by `experiment/paper/scripts/build_paper1_figures.py` from local Phase 1 eval artifacts.",
        "",
        ...
        *_markdown_table(
        ...
        "## Generated Figures",
        "",
        "- `experiment/paper/figures/fig-p1-01-cold-start-tradeoff.svg`",
        "- `experiment/paper/figures/fig-p1-02-selfaware-metrics.svg`",
        "- `experiment/paper/figures/fig-p1-03-paired-transitions.svg`",
        "- `experiment/paper/figures/fig-p1-04-sft-warmed-tradeoff.svg`",
        "- `experiment/paper/figures/fig-p1-05-stated-confidence.svg`",
        "- `experiment/paper/figures/fig-p1-06-confidence-alignment.png`",
        "",
    ]
