...
`experiment/protocol/AMENDMENT-I-8b-scale-and-hyperparameter-gates.md`; it does
...
- Run the hyperparameter/training-exhaust audit in
  `experiment/notes/training-exhaust-hyperparameter-audit.md` before adding new
  LR, beta, KL, reward-weight, epoch, or LoRA-rank variants.

## Runbook

1. Read `experiment/protocol/AMENDMENT-I-8b-scale-and-hyperparameter-gates.md`.
...
4. For thinking variants, follow
   `experiment/notes/thinking-triviaqa-source-probe.md` and adapt the source
...
7. Checkpoint results in
   `docs/sessions/0022 - 8b-scale-and-hyperparameter-planning.md` or a later
...
- Protocol: `experiment/protocol/AMENDMENT-I-8b-scale-and-hyperparameter-gates.md`.
- Session: `docs/sessions/0022 - 8b-scale-and-hyperparameter-planning.md`.
