...
`experiment/protocol/AMENDMENT-G-best-stack-replication-scale-gate.md`; it is
...
1. Read `experiment/protocol/AMENDMENT-G-best-stack-replication-scale-gate.md`
   and `experiment/protocol/AMENDMENT-F-grpo-centered-stacking.md`.
...
- Session checkpoints: `docs/sessions/0020 - best-stack-replication-and-scale-gate.md`.
