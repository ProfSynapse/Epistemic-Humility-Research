...
# Epistemic Humility: Qwen3-4B headline SFT adapter (seed 3)

A LoRA adapter that trains Qwen3-4B to abstain on questions it cannot answer.
This is the supervised fine-tuning (SFT) arm at seed 3 of a three-seed pre-registered
...
| Metric | Value |
|---|---:|
| Refusal recall | 92.34% |
| Over-refusal | 65.25% |
| Correct-on-known | 50.74% |
| Truthful | 40.52% |
| Answer-on-unknown | 7.66% |

Source: [`selfaware_seed_metrics.csv`](https://github.com/ProfSynapse/Epistemic-Humility-Research/blob/main/papers/paper-2-training-regimen/analysis/selfaware_seed_metrics.csv), row `seed=3, arm=sft`.
...
ADAPTER = "professorsynapse/eh-qwen3-4b-headline-sft-seed3-lora"
REVISION = "b3efd6e7aa133c8ad17d35ec569335b6a858d423"
...
- **Revision this card describes**: `b3efd6e7aa133c8ad17d35ec569335b6a858d423`
- **Local source run directory**: `synaptic-tuner/toolset-training-artifacts/runs/local/4b/sft__4b__headline__seed3/20260615_104507/final_model`
- **Run record**: [`sft__4b__headline__seed3.json`](https://github.com/ProfSynapse/Epistemic-Humility-Research/tree/main/archive/experiment/phase1/run_records)
