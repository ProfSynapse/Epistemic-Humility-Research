...
# Epistemic Humility: Qwen3-4B headline SFT adapter (seed 2)

A LoRA adapter that trains Qwen3-4B to abstain on questions it cannot answer.
This is the supervised fine-tuning (SFT) arm at seed 2 of a three-seed pre-registered
...
| Metric | Value |
|---|---:|
| Refusal recall | 87.40% |
| Over-refusal | 64.74% |
| Correct-on-known | 49.88% |
| Truthful | 38.97% |
| Answer-on-unknown | 12.60% |

Source: [`selfaware_seed_metrics.csv`](https://github.com/ProfSynapse/Epistemic-Humility-Research/blob/main/papers/paper-2-training-regimen/analysis/selfaware_seed_metrics.csv), row `seed=2, arm=sft`.
...
ADAPTER = "professorsynapse/eh-qwen3-4b-headline-sft-seed2-lora"
REVISION = "23ae0043bd794be8ede1122effd9ccfecb9d85aa"
...
- **Revision this card describes**: `23ae0043bd794be8ede1122effd9ccfecb9d85aa`
- **Local source run directory**: `synaptic-tuner/toolset-training-artifacts/runs/local/4b/sft__4b__headline__seed2/20260615_090734/final_model`
- **Run record**: [`sft__4b__headline__seed2.json`](https://github.com/ProfSynapse/Epistemic-Humility-Research/tree/main/archive/experiment/phase1/run_records)
