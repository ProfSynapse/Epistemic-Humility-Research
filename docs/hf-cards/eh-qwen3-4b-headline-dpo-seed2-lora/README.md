...
Source: [`selfaware_seed_metrics.csv`](https://github.com/ProfSynapse/Epistemic-Humility-Research/blob/main/papers/paper-2-training-regimen/analysis/selfaware_seed_metrics.csv), row `seed=2, arm=dpo`.
...
ADAPTER = "professorsynapse/eh-qwen3-4b-headline-dpo-seed2-lora"
REVISION = "21326cbcd8a975ca3b89f8552f053392281af23e"
...
- **Revision this card describes**: `21326cbcd8a975ca3b89f8552f053392281af23e`
- **Local source run directory**: `synaptic-tuner/toolset-training-artifacts/runs/local/4b/dpo__4b__headline__seed2/20260615_114512/final_model`
- **Run record**: [`dpo__4b__headline__seed2.json`](https://github.com/ProfSynapse/Epistemic-Humility-Research/tree/main/archive/experiment/phase1/run_records)
