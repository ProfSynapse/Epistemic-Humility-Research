...
# Epistemic Humility: Qwen3-4B headline DPO adapter (seed 3)

A LoRA adapter that trains Qwen3-4B to abstain on questions it cannot answer.
This is the direct preference optimization (DPO) arm at seed 3 of a three-seed pre-registered
...
| Refusal recall | 0.00% |
| Over-refusal | 0.17% |
| Correct-on-known | 21.77% |
| Truthful | 15.08% |
| Answer-on-unknown | 100.00% |

Source: [`selfaware_seed_metrics.csv`](https://github.com/ProfSynapse/Epistemic-Humility-Research/blob/main/papers/paper-2-training-regimen/analysis/selfaware_seed_metrics.csv), row `seed=3, arm=dpo`.
...
ADAPTER = "professorsynapse/eh-qwen3-4b-headline-dpo-seed3-lora"
REVISION = "dc95b05729a9b45e9335d3ac5ed84cc55f84ac81"
...
- **Revision this card describes**: `dc95b05729a9b45e9335d3ac5ed84cc55f84ac81`
- **Local source run directory**: `synaptic-tuner/toolset-training-artifacts/runs/local/4b/dpo__4b__headline__seed3/20260615_130441/final_model`
- **Run record**: [`dpo__4b__headline__seed3.json`](https://github.com/ProfSynapse/Epistemic-Humility-Research/tree/main/archive/experiment/phase1/run_records)
