...
# Epistemic Humility: Qwen3-4B headline DPO adapter (seed 1)

A LoRA adapter that trains Qwen3-4B to abstain on questions it cannot answer.
This is the direct preference optimization (DPO) arm at seed 1 of a three-seed pre-registered
...
- **Training file**: `dpo_train.jsonl`, SHA-256 `22669d2c8c0b19df5fd8b76a86bf7fb8d6403770c8e11759562be13f3bc734a8` as
...
| Refusal recall | 0.10% |
| Over-refusal | 0.09% |
| Correct-on-known | 21.97% |
| Truthful | 15.26% |
| Answer-on-unknown | 99.90% |

Source: [`selfaware_seed_metrics.csv`](https://github.com/ProfSynapse/Epistemic-Humility-Research/blob/main/papers/paper-2-training-regimen/analysis/selfaware_seed_metrics.csv), row `seed=1, arm=dpo`.
...
Source: [`selfaware_seed_summary.csv`](https://github.com/ProfSynapse/Epistemic-Humility-Research/blob/main/papers/paper-2-training-regimen/analysis/selfaware_seed_summary.csv), rows `arm=dpo`.
...
ADAPTER = "professorsynapse/eh-qwen3-4b-headline-dpo-seed1-lora"
REVISION = "9d503e1937d361c97abae6480ecafaac19a0668f"
...
- **Revision this card describes**: `9d503e1937d361c97abae6480ecafaac19a0668f`
- **Local source run directory**: `synaptic-tuner/toolset-training-artifacts/runs/local/4b/dpo__4b__headline__seed1/20260611_211512/final_model`
- **Run record**: [`dpo__4b__headline__seed1.json`](https://github.com/ProfSynapse/Epistemic-Humility-Research/tree/main/archive/experiment/phase1/run_records)
