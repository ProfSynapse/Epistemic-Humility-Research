...
# Epistemic Humility: Qwen3-4B headline KTO adapter (seed 3)

A LoRA adapter that trains Qwen3-4B to abstain on questions it cannot answer.
This is the Kahneman-Tversky optimization (KTO) arm at seed 3 of a three-seed pre-registered
...
| Refusal recall | 0.00% |
| Over-refusal | 0.09% |
| Correct-on-known | 27.19% |
| Truthful | 18.85% |
| Answer-on-unknown | 100.00% |

Source: [`selfaware_seed_metrics.csv`](https://github.com/ProfSynapse/Epistemic-Humility-Research/blob/main/papers/paper-2-training-regimen/analysis/selfaware_seed_metrics.csv), row `seed=3, arm=kto`.
...
ADAPTER = "professorsynapse/eh-qwen3-4b-headline-kto-seed3-lora"
REVISION = "ce68f04723cd9cad30ff58d8037a8629a6adb486"
...
- **Revision this card describes**: `ce68f04723cd9cad30ff58d8037a8629a6adb486`
- **Local source run directory**: `synaptic-tuner/toolset-training-artifacts/runs/local/4b/kto__4b__headline__seed3/20260615_204215_logging_patch/final_model`
- **Run record**: [`kto__4b__headline__seed3.json`](https://github.com/ProfSynapse/Epistemic-Humility-Research/tree/main/archive/experiment/phase1/run_records)
