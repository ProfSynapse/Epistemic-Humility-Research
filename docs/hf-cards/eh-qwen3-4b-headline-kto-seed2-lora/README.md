...
# Epistemic Humility: Qwen3-4B headline KTO adapter (seed 2)

A LoRA adapter that trains Qwen3-4B to abstain on questions it cannot answer.
This is the Kahneman-Tversky optimization (KTO) arm at seed 2 of a three-seed pre-registered
...
| Refusal recall | 0.00% |
| Over-refusal | 0.17% |
| Correct-on-known | 26.62% |
| Truthful | 18.43% |
| Answer-on-unknown | 100.00% |

Source: [`selfaware_seed_metrics.csv`](https://github.com/ProfSynapse/Epistemic-Humility-Research/blob/main/papers/paper-2-training-regimen/analysis/selfaware_seed_metrics.csv), row `seed=2, arm=kto`.
...
ADAPTER = "professorsynapse/eh-qwen3-4b-headline-kto-seed2-lora"
REVISION = "5153f05b96f70314dab796d79b006ee5236680db"
...
- **Revision this card describes**: `5153f05b96f70314dab796d79b006ee5236680db`
- **Local source run directory**: `synaptic-tuner/toolset-training-artifacts/runs/local/4b/kto__4b__headline__seed2/20260615_142046_logging_patch/final_model`
- **Run record**: [`kto__4b__headline__seed2.json`](https://github.com/ProfSynapse/Epistemic-Humility-Research/tree/main/archive/experiment/phase1/run_records)
