...
session_id: 20260626T191124Z-uncertainty-monitor-hypothesis
...
- id: 001-interpretation
  ...
  evidence:
  - docs/sessions/20260625T145842Z-phase-3-model-variation-panel.md#038-result
...
- id: 004-interpretation
  ...
  - notes/experiments/uncertainty-monitor-hypothesis.md
  run_ids: []
  commands: []
  decisions:
  ...
  - 'Created the H_monitor KG node as experiment:uncertainty-monitor-hypothesis (notes/experiments/uncertainty-monitor-hypothesis.md):
...
legacy_session:
  id: '0025'
  path: docs/sessions/0025 - uncertainty-monitor-hypothesis.md
---
