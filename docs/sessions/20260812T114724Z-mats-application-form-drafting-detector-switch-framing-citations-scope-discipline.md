...
updated_at: '2026-09-01T16:51:27Z'
...
- id: 017-checkpoint
  ...
  signals: {}
- id: 018-checkpoint
  at: '2026-09-01T16:51:27Z'
  kind: checkpoint
  title: Checkpoint
  summary: 'Paper 5 second review pass after PRs 592/593: all repaired claims verified
    against governed docs except one units error (3.7 rendered the prompt-off audit
    band ~4-6% recall, n=1032 pool, as a count of 4-6 refusals). Fixed via PR 594
    (merge c002957c), task-12488d closed. Submission sweep: no MATS file echoes any
    repaired or fixed claim; submission-package.md already compatible; docx + assembled
    md stay stale by design pending PI read, rebuild after.'
  evidence: []
  run_ids: []
  commands: []
  decisions: []
...
- at: `2026-09-01T16:51:27Z`
- kind: `checkpoint`
- summary: Paper 5 second review pass after PRs 592/593: all repaired claims verified against governed docs except one units error (3.7 rendered the prompt-off audit band ~4-6% recall, n=1032 pool, as a count of 4-6 refusals). Fixed via PR 594 (merge c002957c), task-12488d closed. Submission sweep: no MATS file echoes any repaired or fixed claim; submission-package.md already compatible; docx + assembled md stay stale by design pending PI read, rebuild after.
