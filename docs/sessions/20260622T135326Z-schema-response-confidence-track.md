...
session_id: 20260622T135326Z-schema-response-confidence-track
...
trajectory:
  ...
  changed_by_session: Defines schema-trained response_confidence data/reward contract,
    includes ambiguous-middle probe rows, and launches the first local schema-SFT
    seed-1 run.
checkpoints: []
legacy_session:
  id: schema-response-confidence-track
  path: docs/sessions/0017 - schema-response-confidence-track.md
---
