...
session_id: 20260625T122352Z-triviaqa-thinking-knowledge-audit
...
- id: 008-decision
  ...
  evidence:
  - experiments/thinking-enabled-parallel-arm/AMENDMENT.md
  - notes/experiments/thinking-triviaqa-source-probe.md
  - notes/experiments/thinking-enabled-training-replication.md
  run_ids: []
  commands: []
  decisions:
...
- id: 009-decision
  ...
  signals: {}
legacy_session:
  id: triviaqa-thinking-knowledge-audit
  path: docs/sessions/0021 - triviaqa-thinking-knowledge-audit.md
---
