...
session_id: 20260623T093654Z-probe-scaled-response-confidence-retrain
...
trajectory:
  ...
  current_position: Amendment D schema-response-confidence seed-1 showed output-contract
    ...
    evals.
  changed_by_session: Opens Amendment E to replace constant SFT/DPO/KTO response-confidence
    targets with probe-scaled targets derived from the original 32-sample p_correct
    evidence.
checkpoints: []
legacy_session:
  id: probe-scaled-response-confidence-retrain
  path: docs/sessions/0018 - probe-scaled-response-confidence-retrain.md
---
