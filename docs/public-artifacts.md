...
| Gemma4-E4B KV-seam quarantine exhaust | [`professorsynapse/eh-gemma4-e4b-kv-seam-quarantine`](https://huggingface.co/datasets/professorsynapse/eh-gemma4-e4b-kv-seam-quarantine) | published (user-approved 2026-08-27) | `24337af7b0a06b92d717bb30e89879584ef165f4` | `experiments/gemma4-e4b-kv-seam-quarantine/analysis-committed/` (repo commit `b642b7c6`) | 85 files / ~5.80 MB copy-everything mirror of analysis-committed plus README + PROVENANCE. Terminal status resolved per experiment.yaml; batch 1 of the exhaust backfill (task-56c61a). Aggregate shape: no row text; zero exclusions. |
| J-space cross-family layer-contrast exhaust | [`professorsynapse/eh-j-space-cross-family-layer-contrast`](https://huggingface.co/datasets/professorsynapse/eh-j-space-cross-family-layer-contrast) | published (user-approved 2026-08-27) | `677d322c8de2ee4eb4ff37c6d9c9d8681cf45703` | `experiments/j-space-cross-family-layer-contrast/analysis-committed/` (repo commit `b642b7c6`) | 46 files / ~6.64 MB copy-everything mirror of analysis-committed plus README + PROVENANCE. Terminal status resolved per experiment.yaml; batch 1 of the exhaust backfill (task-56c61a). Aggregate shape: no row text; zero exclusions. |
| Abstention-install bounded-site-sweep exhaust | [`professorsynapse/eh-caution-install-bounded-site-sweep`](https://huggingface.co/datasets/professorsynapse/eh-caution-install-bounded-site-sweep) | published (user-approved 2026-08-27) | `e6e7dea57cf4ca06e046f70e5201648039088d28` | `experiments/caution-install-bounded-site-sweep/analysis-committed/` (repo commit `b642b7c6`) | 23 files / ~0.77 MB copy-everything mirror of analysis-committed plus README + PROVENANCE. Terminal status resolved per experiment.yaml; batch 1 of the exhaust backfill (task-56c61a). Aggregate shape: no row text; zero exclusions. | <!-- terminology-ok: retired 'caution install' survives only inside the governed slug/URL -->
| Gemma4-E4B pocket-ladder exhaust | [`professorsynapse/eh-gemma4-e4b-pocket-ladder`](https://huggingface.co/datasets/professorsynapse/eh-gemma4-e4b-pocket-ladder) | published (user-approved 2026-08-27) | `c9c30f7cf2ab7ef61ff2dddbc367f5bc06d22fbe` | `experiments/gemma4-e4b-pocket-ladder/analysis-committed/` (repo commit `b642b7c6`) | 23 files / ~1.32 MB copy-everything mirror of analysis-committed plus README + PROVENANCE. Terminal status resolved per experiment.yaml; batch 1 of the exhaust backfill (task-56c61a). Aggregate shape: no row text; zero exclusions. |
| Qwen3.5-4B midband doubt-snap exhaust | [`professorsynapse/eh-qwen35-4b-midband-doubt-snap`](https://huggingface.co/datasets/professorsynapse/eh-qwen35-4b-midband-doubt-snap) | published (user-approved 2026-08-27) | `774c1c55d14b03e301f63e03062a3c42b2e11e50` | `experiments/qwen35-4b-midband-doubt-snap/analysis-committed/` (repo commit `b642b7c6`) | 18 files / ~1.79 MB copy-everything mirror of analysis-committed plus README + PROVENANCE. Terminal status resolved per experiment.yaml; batch 1 of the exhaust backfill (task-56c61a). Aggregate shape: no row text; zero exclusions. |
| Qwen3.5-4B midband held-out exhaust | [`professorsynapse/eh-qwen35-4b-midband-heldout`](https://huggingface.co/datasets/professorsynapse/eh-qwen35-4b-midband-heldout) | published (user-approved 2026-08-27) | `ba7249a84be319827b33241563599188ce8c9673` | `experiments/qwen35-4b-midband-heldout/analysis-committed/` (repo commit `b642b7c6`) | 4 files / ~0.36 MB copy-everything mirror of analysis-committed plus README + PROVENANCE. Terminal status resolved per experiment.yaml; batch 1 of the exhaust backfill (task-56c61a). Aggregate shape: no row text; zero exclusions. |
| J-space family atlas (llama+mistral) exhaust | [`professorsynapse/eh-jspace-family-atlas`](https://huggingface.co/datasets/professorsynapse/eh-jspace-family-atlas) | published (user-approved 2026-08-27) | `f028cfdf535b35b2e43023dffbd74d10e3a5c705` | `experiments/jspace-family-atlas/analysis-committed/` (repo commit `b642b7c6`) | 9 files / ~1.22 MB copy-everything mirror of analysis-committed plus README + PROVENANCE. Terminal status resolved per experiment.yaml; batch 1 of the exhaust backfill (task-56c61a). Aggregate shape: no row text; zero exclusions. |
| Gemma-4-E4B family atlas exhaust | [`professorsynapse/eh-gemma-4-e4b-family-atlas`](https://huggingface.co/datasets/professorsynapse/eh-gemma-4-e4b-family-atlas) | published (user-approved 2026-08-27) | `dc8da5caf7524e6193bb71b6e4ef6b646d3cc9ca` | `experiments/gemma-4-e4b-family-atlas/analysis-committed/` (repo commit `b642b7c6`) | 11 files / ~0.64 MB copy-everything mirror of analysis-committed plus README + PROVENANCE. Terminal status resolved per experiment.yaml; batch 1 of the exhaust backfill (task-56c61a). Aggregate shape: no row text; zero exclusions. |
| Qwen3-4B family atlas exhaust | [`professorsynapse/eh-qwen3-4b-family-atlas`](https://huggingface.co/datasets/professorsynapse/eh-qwen3-4b-family-atlas) | published (user-approved 2026-08-27) | `114816c1ff18914abeca0522c3b79c4ae4905b23` | `experiments/qwen3-4b-family-atlas/analysis-committed/` (repo commit `b642b7c6`) | 5 files / ~0.35 MB copy-everything mirror of analysis-committed plus README + PROVENANCE. Terminal status resolved per experiment.yaml; batch 1 of the exhaust backfill (task-56c61a). Aggregate shape: no row text; zero exclusions. |
| Qwen3.5-4B family atlas exhaust | [`professorsynapse/eh-qwen35-4b-family-atlas`](https://huggingface.co/datasets/professorsynapse/eh-qwen35-4b-family-atlas) | published (user-approved 2026-08-27) | `c82b14245ac9692b6099f0b77ed6286976dee6ee` | `experiments/qwen35-4b-family-atlas/analysis-committed/` (repo commit `b642b7c6`) | 5 files / ~0.61 MB copy-everything mirror of analysis-committed plus README + PROVENANCE. Terminal status null-result per experiment.yaml; batch 1 of the exhaust backfill (task-56c61a). Aggregate shape: no row text; zero exclusions. |
