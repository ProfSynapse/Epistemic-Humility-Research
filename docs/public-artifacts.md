...
|---|---|---|---|---|---|
| locked training-regimen redistributable datasets | [`professorsynapse/epistemic-humility-phase1`](https://huggingface.co/datasets/professorsynapse/epistemic-humility-phase1) | published | `922d3b52ff6e8143b2701c3a7562909077eba4ab` | `archive/experiment/phase1/data/qwen3-4b-instruct/` | Qwen3 4B train/dev JSONLs plus `README.md`, `build_manifest.json`, and `questions_frozen.json`. Excludes restricted bridge/OpenMOSS/Cheng-derived raw data. |
