...
Outputs:
  meta-analysis/analysis/tables/abstention_operating_points.csv
  meta-analysis/analysis/tables/abstention_operating_points.md
  meta-analysis/analysis/figures/abstention_operating_points.svg
  meta-analysis/analysis/figures/abstention_operating_points.pdf, if local SVG conversion support is available

Run:
  python meta-analysis/analysis/operating_point_artifacts.py
"""
