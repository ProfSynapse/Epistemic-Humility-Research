...
- '[[sparsity-penalty-promotes-feature-composition]]'
relationships:
- type: proposes
  target: '[[sae-stitching]]'
  target_id: method:sae-stitching
- type: proposes
  target: '[[metasae]]'
  target_id: method:metasae
- type: proposes
  target: '[[novel-latent]]'
  target_id: term:novel-latent
- type: proposes
  target: '[[reconstruction-latent]]'
  target_id: term:reconstruction-latent
- type: uses
  target: '[[sparse-autoencoder]]'
  target_id: method:sparse-autoencoder
- type: studies
  target: '[[canonical-units-of-analysis]]'
  target_id: term:canonical-units-of-analysis
- type: studies
...
- type: supports
  target: '[[sparsity-penalty-promotes-feature-composition]]'
  target_id: mechanism:sparsity-penalty-promotes-feature-composition
---
## Abstract
