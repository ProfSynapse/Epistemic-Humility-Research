...
uses-method: ["[[multi-task-learning]]", "[[linear-probe]]"]
evaluates-on: ["[[evidence-accumulation-task]]"]
measures: ["[[ood-coefficient-of-determination]]"]
studies: ["[[disentangled-representation]]", "[[continuous-attractor]]"]
mechanisms: ["[[multitask-pressure-induces-disentanglement]]", "[[observation-noise-enables-boundary-localization]]", "[[transformer-advantage-in-disentanglement]]"]
---
## Abstract
