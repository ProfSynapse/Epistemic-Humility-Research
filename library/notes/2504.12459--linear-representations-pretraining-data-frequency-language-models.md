...
- '[[lre-features-improve-frequency-estimation]]'
relationships:
- type: proposes
...
- type: measures
  target: '[[within-magnitude-accuracy]]'
  target_id: metric:within-magnitude-accuracy
- type: studies
...
- type: supports
  target: '[[co-occurrence-frequency-drives-lre-formation]]'
  target_id: mechanism:co-occurrence-frequency-drives-lre-formation
- type: supports
  target: '[[lre-features-improve-frequency-estimation]]'
  target_id: mechanism:lre-features-improve-frequency-estimation
---
## Abstract
