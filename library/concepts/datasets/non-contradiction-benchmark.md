...
**Why it matters here:** Provides a cheap, string-match-scorable probe for error-mimicry sycophancy that is independent of annotator opinion and distinct in design from belief-agreement benchmarks. Can be run as a lightweight Phase 1 post-training check.
