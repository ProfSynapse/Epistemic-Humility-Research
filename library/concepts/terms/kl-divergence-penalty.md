...
**Why it matters here:** The KL penalty determines how far any of the three training arms (SFT, DPO, KTO) can shift the model toward abstention before degrading other capabilities, which connects directly to the alignment-tax measurement in the locked training-regimen study.
