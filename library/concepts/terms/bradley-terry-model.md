...
**Why it matters here:** The Bradley-Terry assumption underlies the [[direct-preference-optimization]] loss used in the DPO arm of the Phase 1 experiment, so its distributional assumptions (transitivity, scale-free rewards) implicitly constrain what DPO can learn from abstention preference pairs.
