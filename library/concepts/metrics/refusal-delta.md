...
**Why it matters here:** RF Delta is a targeted discriminability metric that separates over-refusal (refusing answerables) from under-refusal (answering unanswerables), making it more informative than raw abstention rate alone. In the locked training-regimen SFT-vs-DPO-vs-KTO study, tracking RF Delta alongside [[abstention-rate]] reveals whether a training method achieves genuine knowledge-boundary sensitivity or merely shifts the overall refusal baseline.
