...
**Why it matters here:** SFT is one of the three training arms in the locked training-regimen experiment and serves as the baseline and prerequisite for DPO and KTO initialization. Prior work shows SFT alone can induce over-refusal ([[sft-abstention-causes-over-refusal]]), motivating the preference-optimization alternatives.
