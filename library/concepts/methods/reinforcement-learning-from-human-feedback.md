...
**Why it matters here:** RLHF is the ancestor of the DPO and KTO arms in the Phase 1 SFT-vs-DPO-vs-KTO abstention study. Understanding how both methods simplify away the reward model and RL loop contextualizes why they are cheaper to train while still inheriting the RLHF alignment objective.
