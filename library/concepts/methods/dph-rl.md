...
**Why it matters here:** Directly addresses the Pass@k vs. Pass@1 paradox in RLVR by preventing catastrophic forgetting and OOD generalization collapse without requiring external teacher models. Offers a compute-efficient alternative to maintaining a live reference policy during RL training, relevant to the Synaptic Tuner budget in locked training-regimen arms.
