...
EXPECTED_IMAGE_DIGEST = "sha256:d445632098cd2c70c115fe84d5343ff98286ac3f510a2d4c9cb488b550a3d23c"
...
def terminal_containment_scan(*, private_texts: Iterable[str] = ()) -> dict[str, Any]:
    ...
    allowed_top = {"aggregate_results.json", "containment_report.json"}
    allowed_cell = {
