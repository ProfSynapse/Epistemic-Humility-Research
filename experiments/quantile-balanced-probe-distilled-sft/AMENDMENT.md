...
The calibration-gap thread (Paper 2, `papers/paper-3-knows-but-doesnt-say/manuscript.md`)
...
1. **The model has the signal internally.** A 1-D doubt-axis readout is calibrated
   ...
   training [calibration: docs/sessions/20260627T093723Z-caution-vs-doubt-knowledge-gate.md cp004; probe: _latent_knowledge_controls/].
