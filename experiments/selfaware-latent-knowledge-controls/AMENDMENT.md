...
readout, and do the lexical, over-refusal-gap, cross-regimen, and caution-axis
...
regimens, lexical controls do not explain it away, over-refused known items sit
near the known pole rather than the unknown pole, and the caution-axis transfer
panel records cross-regimen agreement as a separate axis-geometry check.

Verdict: exploratory control package banked as historical provenance for later
paper/amendment claims; no launchable instrument is defined here and no result is
pooled with the locked Phase 1 matrix.
