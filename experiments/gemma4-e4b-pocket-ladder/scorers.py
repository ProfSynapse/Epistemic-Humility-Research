...
#
# Source: archive/experiment/phase1/eval/scorers.py
#   (was experiment/phase1/eval/scorers.py until main commit 21cd5c50
#    "Archive legacy experiment tree and remove active phase labels" moved it
#    into archive/; grader.py's old hardcoded EVAL_DIR no longer resolved it).
# Source sha256: 75e690f583d83d654cb88a3b066b39acb7e9e1b954c9d5677d4b887d6c30905a
# Vendored 2026-07-23 for experiment j-space-cross-family-layer-contrast to drop
# the external-path dependency (sibling convention: the experiment carries its
# own scoring, no external `scorers` module dependency).
# BYTE-IDENTITY: every byte below this banner line is the source VERBATIM; the
# post-banner body sha256 equals the Source sha256 above.
# --- BEGIN verbatim source (byte-identical to Source sha256) ---
#!/usr/bin/env python3
