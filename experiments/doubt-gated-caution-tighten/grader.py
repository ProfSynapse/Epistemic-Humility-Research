"""Grader for the doubt-gated-caution-tighten steer cell.

Ported (logic, not import, since the source lives on an unmerged sibling
branch) from `two-signal-caution-regulation-instruct/two_signal_grader.py`
