...
import sycophancy_answer_row_manifest as manifest
...
def test_build_manifest_selects_sycophancy_contrast_rows(tmp_path: Path):
    ...
    assert built["schema_version"] == "mechinterp-selfaware-frozen-row-manifest/v1"
    assert built["scope"]["source_schema_version"] == "mechinterp-sycophancy-answer-row-manifest/v1"
