"""Offline tests for residual_intervention_runner.run_config's
...
import residual_intervention_runner as runner  # noqa: E402
...
def test_resolve_model_ref():
    ...
    rel = "experiments/common/knowledge_probe"
