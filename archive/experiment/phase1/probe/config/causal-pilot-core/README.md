...
Owner decision: archive-only historical provenance for the legacy Phase 3 local causal-pilot runner template, full candidate inventory, and local sweep plan. These files remain referenced by historical sweep configs and procedural runbook text, but they are not the home for new experiment instruments.
