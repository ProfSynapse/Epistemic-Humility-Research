...
candidate, logit-sweep, and logit-cell aggregation configs formerly stored
under `experiment/phase1/probe/config/`.
...
The component group contains candidate and sweep pairs plus answer/refusal
logit-cell aggregation configs for simple axes, composite directions,
same-layer single controls, and multilayer controls. Sweep configs point to the
archived causal-pilot core runner template.
