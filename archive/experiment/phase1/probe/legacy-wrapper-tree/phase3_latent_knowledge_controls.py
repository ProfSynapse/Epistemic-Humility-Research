#!/usr/bin/env python3
"""Compatibility wrapper for the self-aware latent-knowledge controls script."""
...
_spec = importlib.util.spec_from_file_location("_phase3_latent_knowledge_controls_impl", TARGET)
