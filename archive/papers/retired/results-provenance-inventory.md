...
(Appendix A of `papers/paper-3-knows-but-doesnt-say/manuscript.md` and
`papers/paper-4-two-signal-readout/manuscript.md`), which map every published number to
