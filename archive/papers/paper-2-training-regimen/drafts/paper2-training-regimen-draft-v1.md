...
reproducibility: "See repository paths papers/paper-2-training-regimen/scripts/build_figures.py and papers/paper-2-training-regimen/analysis/"
---
...
repo-relative script path `papers/paper-2-training-regimen/scripts/build_figures.py`
regenerates the tables used in this draft and writes them under
`papers/paper-2-training-regimen/analysis/`.
...
`papers/paper-2-training-regimen/scripts/build_figures.py`, which rebuilds the generated
tables in `papers/paper-2-training-regimen/analysis/` and charts in
`papers/paper-2-training-regimen/figures/` from local Phase 1 evaluation artifacts.
