...
reward (GRPO v2 from `experiments/probe-scaled-response-confidence/AMENDMENT.md`)
is installed and runs, and `experiments/grpo-centered-stacking/AMENDMENT.md`
...
result into a launched arm or into reporting requires a new signed experiment
amendment under `experiments/<slug>/AMENDMENT.md`, not an edit to this note.
...
- GRPO training is a signed arm under Amendment F, but a curriculum variant is a
  ...
  new signed amendment per `papers/common/amendment-governance.md`.
...
1. Setup: read `experiments/grpo-centered-stacking/AMENDMENT.md` and
...
- Promotion to a launched/reported arm requires the
  `papers/common/amendment-governance.md` sign-off rule (a new amendment).
