<!-- ARCHIVED 2026-07-10 (PI decision): unlaunched DRAFT, never signed, never run.
     Recovered from branch amendment-y-thinking-readout (head c08a40ce) during the
     stranded-worktree/branch audit. Kept for design reuse (thinking-mode readout,
     blind cot_confidence judge rubric, seq_logprob estimator-divergence guard).
     Not a governed evidence record. -->
