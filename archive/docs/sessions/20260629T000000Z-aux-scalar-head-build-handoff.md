...
session_id: 20260629T000000Z-aux-scalar-head-build-handoff
title: Aux Scalar Head Build Handoff
status: complete
created_at: '2026-06-29T00:00:00Z'
updated_at: '2026-06-29T00:00:00Z'
phase: phase3
question: How should a fresh builder implement the generic frozen-base aux_head readout
  feature (Phase A) in the synaptic-tuner submodule?
tags:
- aux-head
- synaptic-tuner
- engine-build
...
legacy_session:
  id: '0027'
  path: docs/sessions/0027 - aux-scalar-head-build-handoff.md
---
...
- Motivating results (root repo): `experiments/probe-as-oracle-readout-ceiling/AMENDMENT.md`
  (in-distribution readout ceiling, all gates pass) and
  `experiments/xdataset-probe-transfer/AMENDMENT.md` (cold cross-dataset
