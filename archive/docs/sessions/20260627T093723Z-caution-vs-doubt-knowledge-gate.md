...
session_id: 20260627T093723Z-caution-vs-doubt-knowledge-gate
...
- id: 006-interpretation
  ...
  evidence:
  - docs/sessions/20260623T093654Z-probe-scaled-response-confidence-retrain.md; experiment/phase1/eval/results_amendment_e_response_confidence_selfaware_clean_sft_grpo_seed1_corrected_base_full_4b/
  run_ids: []
  commands: []
  decisions:
...
legacy_session:
  id: '0026'
  path: docs/sessions/0026 - caution-vs-doubt-knowledge-gate.md
---
...
- evidence:
  - `experiment/phase1/probe/analysis/current_clean_grpo_v2_caution_perp_residual_intervention/summary.json (untracked per convention); experiment/phase1/probe/build_caution_perp_direction.py; archive/experiment/phase1/probe/config/grpo-v2-residual-repair/phase3_current_clean_grpo_v2_caution_perp_residual_intervention.yaml`
- decisions:
...
- evidence:
  - `experiments/contrastive-sft-behavior-conditional-confidence/AMENDMENT.md (DRAFT)`
...
- evidence:
  ...
  - amendment: experiments/answer-subspan-masked-contrastive-sft/AMENDMENT.md (DRAFT, pending sign-off)
- decisions:
...
- evidence:
  - amendment: experiments/grpo-v3-on-contrastive-sft-base/AMENDMENT.md (SIGNED 2026-06-28)
...
- evidence:
  ...
  - amendment RESULT: experiments/grpo-v3-on-contrastive-sft-base/AMENDMENT.md §7
- decisions:
