...
class DockerProviderProfileV1:
    ...
    def from_mapping(cls, value: Mapping[str, object]) -> "DockerProviderProfileV1":
        root = _object(
            ...
            frozenset({
                ...
                "model", "accelerator", "resources", "network", "docker_policy_ref", "artifacts",
            }),
        ...
        model = _object(root["model"], frozenset({"load_in_4bit"}), "Docker model policy")
        ...
        return cls(
            ...
            _text(root["docker_policy_ref"], "docker_policy_ref", pattern=_REF),
    ...
    def to_dict(self) -> dict[str, object]:
        return {
            ...
            "docker_policy_ref": self.docker_policy_ref,
            "artifacts": {
