...
- 2026-09-01 @claude: consolidated fix pass from the eight-reviewer adversarial section review (PI-approved): all 6 blockers repaired (Methods displacement apparatus cut, Newcombe CI added to Appendix E, Gemma operating-range inversion, Llama specificity inversion in Section 5, Mistral one-operating-point wording), 23 majors fixed and 1 resolved by retention with rationale (over-refusal definition), all minors applied except the verbatim injection-template em dash; Gemma depth count corrected to nine sites everywhere, terminology standardized on "wide two-stage stack", three orphan references cited in the introduction, evidence_base extended by 8 slugs, idk-switch coverage row set NOT NARRATED, coverage table regenerated. Every replacement number re-verified against its governed AMENDMENT before writing.
- 2026-09-01 @claude: restored the IDK switch name to Section 4.5 at its validated Qwen3.5-4B hs20 operating point per PI direction (name from papers/common/terminology.md row 3, PI scope ruling 2026-08-10); numbers verified against the naming cell Outcome (+61.3pp endpoint IDK jump, CI lower 56.5 vs 15 floor, hedged share falls, placebo within 2.3pp); coverage row back to 4.5.
