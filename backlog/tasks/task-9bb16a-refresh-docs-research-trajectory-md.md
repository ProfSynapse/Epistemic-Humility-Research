...
## Acceptance Criteria
- [ ] Paper status headers reflect the August editorial arcs
- [ ] Paper 5 section reflects the llama wide-instrument rescore and current state
- [ ] Doc's own last-updated marker bumped
